...
<?php
    ...
    <li><a href="'.url_for('/interfaces/subjects/show.php?id='.$id.'&subject_name='.$subject_name.'&teachers='.urlencode($teachers).'&teacher_id=all').'">All Students Marks</a></li>

    <li><a href="'.url_for('/interfaces/subjects/show.php?id='.$id.'&subject_name='.$subject_name.'&teachers='.urlencode($teachers).'&teacher_id='.urlencode($teacherfirst[0])).'">'.$teacherfirst[1].'</a></li>

    <li><a href="'.url_for('/interfaces/subjects/show.php?id='.$id.'&subject_name='.$subject_name.'&teachers='.urlencode($teachers).'&teacher_id='.urlencode($teachersecond[0])).'">'.$teachersecond[1].'</a></li>
...
<?php foreach ($main_subject_container as $student){
    ...
    <br>
    <br>
<a href="<?php echo url_for('/interfaces/subjects/index.php') ?>"><< Back</a>
<br>
